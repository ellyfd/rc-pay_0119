                      ...
                      <tr className="bg-slate-50 font-semibold">
                       ...
                       {groupBuy.discount_rules?.length > 0 && groupBuy.fixed_discount_allocation && (
                         <tr className="bg-slate-50">
                           <td colSpan={groupBuy.discount_rules?.length > 0 ? 5 : 4} className="px-2 sm:px-3 py-1 sm:py-2 text-right text-slate-600 text-xs sm:text-sm">
                             {(() => {
                               const allocationMap = {
                                 'proportional': '(按比例分攤)',
                                 'per_item': '(按項目分攤)',
                               ...
                               return allocationMap[groupBuy.fixed_discount_allocation] || '';
                             })()}
                           </td>
                           {hasDiscountDecimals && isOrganizer && isClosed && (
                             <td></td>
